...
export default function TVDetailPage() {
  ...
  const [recentReviews, setRecentReviews] = useState<
    TVDetail["community"]["recentReviews"]
  >([]);
  ...
  useEffect(() => {
    if (show) {
      setRecentReviews(show.community.recentReviews || []);
    }
  }, [show]);
    ...
    fetch(`${apiBase}/api/reviews/me`, {
      ...
      .then((data) => {
        const match = data?.data?.find(
          (r: any) => r.media?.tmdbId === show.id && r.media?.type === "TV_SHOW",
        );
  ...
  async function handleSubmitReview() {
    ...
    try {
      ...
      // Update show counts if present
      if (show) {
        setShow({
          ...show,
          community: {
            ...show.community,
            totalReviews: show.community.totalReviews + 1,
          },
        });
      }
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 240 }}>
            ...
            >
              ...
              >
                {new Date(show.first_air_date).toLocaleDateString(undefined, {
                  year: "numeric",
                  month: "short",
                  day: "numeric",
                })}
            ...
            {[
              {
                label: "Avg Rating",
                value:
                  show.community.avgRating != null
                    ? show.community.avgRating.toFixed(1)
                    : "—",
              },
